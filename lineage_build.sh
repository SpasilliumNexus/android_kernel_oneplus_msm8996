...
########################################################
#  Lazy kernel build script for LineageOS
...
LINEAGE_HOME=${HOME}/Development/android-kernels/lineageos
KERNEL_HOME=${HOME}/Development/android-kernels/lineageos/lineage-android_kernel_oneplus_msm8996
OUTPUT_HOME=${HOME}/Development/android-kernels/lineageos/lineage-android_kernel_oneplus_msm8996-output
ZIMAGE_HOME=$OUTPUT_HOME/arch/arm64/boot
KERNEL_IMAGE=$ZIMAGE_HOME/Image.gz-dtb
OP3_DEFCONFIG=lineageos_oneplus3_defconfig
DTB_IMAGE=dtb
ARM_ARCH=arm64
...
ZIPPED_OUTPUT=${HOME}/Development/android-kernels/lineageos/lineage-android_kernel_oneplus_msm8996-completed
...
function confirm_build {
  ...
  echo
  echo -e $COL_GREEN"The newly created zip can be found in /Development/android-kernels/lineageos/lineage-android_kernel_oneplus_msm8996-completed."$COL_RESET
  echo
}
